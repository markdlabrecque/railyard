...
@test "board lists engines grouped by status with project, shape, mode, age and last line" {
...
@test "board shows pr url and unread inbox count, and is calm when empty" {
  run ry-board.sh
