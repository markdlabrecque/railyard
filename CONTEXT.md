...
**Yard**:
The whole railyard installation, and the terminals it runs in — a tmux session named `railyard` by default, or Orca terminals / cmux workspaces when `RY_BACKEND` says so.
